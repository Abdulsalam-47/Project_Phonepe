...
if select == "HOME":
    ...
    with col3:
        st.image(Image.open(r"d:\Phonepe\phonepe1.jpg"),width=600)
    ...
    question= st.selectbox("Select the Question",["1. Transaction Amount and Count of Aggregated Insurance",
                                                    ...
                                                    "6. Brandwise Top 10 and average of Transaction Count and Percentage of Aggrecated User",
    ...
    elif question == "6. Brandwise Top 10 and average of Transaction Count and Percentage of Aggrecated User":
